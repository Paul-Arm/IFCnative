...
export function labelForLine(line: Record<string, unknown> | undefined, fallback: string) {
...
export function valueTypeName(value: unknown) {
  ...
  return value.constructor?.name === 'Object' ? undefined : value.constructor?.name;
}
