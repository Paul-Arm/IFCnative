...
- [~] Recent files/session restore. Native shell now persists recent IFC paths, can reopen/clean missing entries, and restores window/pane visibility plus pane widths; automatic full workspace restore is still pending.
